...
//
//		**[1단계:개념] 25.** 
//		지역변수는 특정 영역(블록) 내에서만 사용되는 변수이며, 그 영역을 벗어나면 사용할 수 없습니다. for문 내의 변수 i는 지역변수입니다.
...
//		    public static void main(String[] args) {
//		        for (int i = 1; i <= 20; i++) {
//		            if (i % 3 == 0 || Integer.toString(i).contains("3")) { // 뒷부분 코드는 우리가 모르는거라 그 10으로 나누고 하는거 해도됨
		//			
		//			10 20 30 40 단위 제외
		//			13  ==> i%10 =3 -? 3==0 짝!
...
//
//		**[1단계:개념] 43.** 
//		필드는 클래스의 속성 또는 상태를 나타내는 변수입니다. 클래스 내에서 선언
//
